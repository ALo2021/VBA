VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Calendario2 
   Caption         =   "Validade"
   ClientHeight    =   5685
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   6900
   OleObjectBlob   =   "Calendario2.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Calendario2"
...
Calendario2.year.Caption = Calendario2.year - 1
Assigndate2
...
If Calendario2.monthh.Caption = "dezembro" Then
Calendario2.monthh.Caption = "janeiro"
Else
Calendario2.monthh.Caption = monthName(month(DateValue("1 " & Calendario2.monthh & " 2024")) + 1)
End If
Assigndate2
...
If Calendario2.monthh.Caption = "janeiro" Then
Calendario2.monthh.Caption = "dezembro"
Else
Calendario2.monthh.Caption = monthName(month(DateValue("1 " & Calendario2.monthh & " 2024")) - 1)
End If
Assigndate2
...
Inserir.Label7.Caption = Calendario2.Controls(ActiveControl.Name).Caption & "/" & MonthNameToNumber(Calendario2.monthh.Caption) & "/" & Calendario2.year.Caption
Unload Me
End Sub
